    ...
    <div id="search">
		...
		<div id="sidebar">
			<a href="" class="visible-phone"><i class="icon icon-home"></i>用户管理</a>
				...
				<li class="active"><a href="turnToTeamManage.htm"><i class="icon icon-user"></i> <span>店铺管理</span></a></li>
						...
						<table class="table table-striped sortable" >
							...
							<c:forEach items="${teamList}" var="team">
								<tr>
									...
									<td style="text-align:center;">
									  <a class="btn success" href="alterTeamState.htm?teamId=${team.teamId}&type=3">删除店铺</a>
									</td>
								</tr>
								</c:forEach>							
							</tbody>
