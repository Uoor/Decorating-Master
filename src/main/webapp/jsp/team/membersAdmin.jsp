...
<head>
    ...
    <title>${userTeam2.team.teamName}的店铺成员 - 裱花大师</title>
                                                ...
                                                <c:if test="${userTeam.userPosition=='组长'}">
                                                    <p>
                                                        <a href="addApplyUser.htm?userTeamId=${ut.userTeamId}"
                                                           class="opt" title="把${ut.user.userName}加入店铺">加</a>
                                                    ...
                                                    <c:if test="${userTeam1.userPosition=='组长'}">
                                                        <p>
                                                            <a href="kickOutTeam.htm?userTeamId=${uts.userTeamId}"
                                                               class="opt" title="把${uts.user.userName}踢出店铺">踢</a>
    ...
    <div id="course-side">
        <div class="membercol">
            <div class="mod">
                ...
                <p class="stext">把用户添加进店铺，点击头像旁边的"<b>加</b>"。</p>

                <p class="stext">把用户移除店铺申请列表，点击头像旁边的"<b>除</b>"。</p>
            </div>

            <div class="mod">
                <h2>踢人和封禁</h2>

                <p class="stext">把成员踢出店铺，点击头像旁边的"<b>踢</b>"，踢出去的用户以后可以再次加入店铺。</p>

                <p class="stext">永久禁止一个成员加入本店铺，点击头像旁边的"<b>黑</b>"。</p>
            </div>
        </div>
    </div>
</c:if>
