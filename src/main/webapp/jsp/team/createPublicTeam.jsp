                    ...
                    <div class="container-padding clearfix">
                        ...
                        <form id="group-form" class="form group-form" method="post" action="createTeam.htm">
                            ...
                            <p>
                                ...
                                <select id="group_joinMethod" name="method" required="required"><option value="1">允许任何人加入店铺</option><option value="2">[即将开放] 只有接受组员邀请才能加入店铺</option><option value="3">[即将开放] 需要店铺管理员批准后才能加入店铺</option></select>
                            </p>
