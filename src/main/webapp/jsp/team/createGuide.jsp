                    ...
                    <section class="container group" style="margin-top: 60px;margin-left: 90px;">
                        <div class="container-padding clearfix">
                            ...
                            <div class="normal-main">
                                ...
                                <h2 class="noborder">请选择你要创建的店铺类型</h2>

                                <div class="group-type-box">
                                    <div class="group-type-inner-box"><p>公开店铺</p><p><a href="createTeamPage.htm" class="btn btn-success"><span>创建</span></a></p></div>
                                    <ul class="text-list">
                                        <li><span class="text-error">需要200学分及以上用户才能创建。</span></li>
                                        <li>裱花大师的任何成员都可见。</li>
                                        <li>可以设置成员的加入方式。</li>
                                        <li>非店铺成员可以浏览话题，但不能发表回复。</li>
                                        <li>以后可以变为私密店铺。</li>
                                    </ul>
                                </div>
                                <!--
                                    <div class="group-type-box">
                                      <div class="group-type-inner-box ml15"><p>私密店铺</p><p><span style="color:#999;">Coming soon.</span></p></div>
                                      <ul class="text-list">
                                        <li>只有店铺成员知道店铺的存在。</li>
                                        <li>不会显示在店铺列表中，不会被搜索到。</li>
                                        <li>只有接受组员邀请才能加入店铺。</li>
                                        <li>以后永远不能变为公开的店铺。</li>
                                      </ul>
                                    </div>
                                -->
                                ...
                                <div class="notice">
                                    注意事项：<br />
                                    1、店铺主题应为各类知识的交流或分享，不能出现明显广告内容，且不违背国家和地方相关法律法规； <br />
                                    2、申请店铺时请查看<a href="teamPage.htm">现有店铺列表</a>，避免出现重合。<br />
                                    3、店铺创建后，工作人员将会进行审核，违规店铺将被要求进行修改或被删除。
                                </div>
